        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 col-lg-2">
                ...
                <ul class="footer_menu">
                    @foreach (App\Models\CategoryAdmin::layAllShow()->take(8) as $category)
                        <li><a href="{{ route('blog_category', ['id' => $category->id]) }}" class=""><i
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                @foreach (App\Models\NewsAdmin::Lay4NewTrendding()->take(3) as $new)
                <div class="footer_makes_sub_font">{{\Carbon\Carbon::parse($new->adddate)->format('M d ,y')}}</div>
                <a href="{{route('detail_blog',['id' =>$new->id])}}" class="footer_post pb-4"> {{$new->title}}</a>
                 @endforeach
            </div>
            <div class="col-12 col-md-12 col-lg-4 ">
                <div class="footer_main_title py-3">Latest posted article</div>
                @foreach(App\Models\NewsAdmin::layAllShow()->take(9) as $new)
                <a href="{{route('detail_blog',['id' =>$new->id])}}" class="footer_img_post_6"><img src="{{ asset('images/'.$new->image) }}"
                    alt="img" /></a>
                @endforeach
            </div>
        </div>
            ...
            <div class="col-12 col-md-8 col-lg-7 ">
                <form action="{{ route('subscriber.store') }}" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control fh5co_footer_text_box" name="subscriber"
                            placeholder="Enter your email..." aria-describedby="basic-addon1">
                        <button type="submit"
                            style="background-color:#f5bc04 ;padding:10px 20px; color:#fff;border-bottom: 2px solid #fff;font-size :15px">
